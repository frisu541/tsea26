...
# Important: target_library must point to a technology database
# For CentOS: Change /isy to /sw
set target_library {"/isy/mentor/libraries/cmos065_522/CORE65LPLVT_5.1/libs/CORE65LPLVT_nom_1.20V_25C.db"}
